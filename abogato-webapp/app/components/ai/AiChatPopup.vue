  ...
  >
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <UCard
            :ui="{ body: 'p-0', header: 'px-4 py-3 sm:px-5 sm:py-4', footer: 'p-0' }"
            class="max-h-[min(32rem,calc(100dvh-7rem))] w-[min(32rem,calc(100vw-1.25rem))] overflow-hidden rounded-3xl border border-default/70 bg-default/95 shadow-2xl backdrop-blur sm:max-h-none sm:h-auto sm:w-[468px] lg:w-[546px]"
          >
            <template #header>
